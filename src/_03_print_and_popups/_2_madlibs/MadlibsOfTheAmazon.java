...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog("please give me a adjective");
		// Get the player to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("please give me a liquid");
		// Get the player to enter a body part
		String body = JOptionPane.showInputDialog("please give me a  body part");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("please give me a verb that starts with are");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("please give me a place");
